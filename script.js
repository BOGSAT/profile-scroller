...
nextBtn.addEventListener('click', () => {
  ...
  const infoParagraphs = profileInfo.querySelectorAll('p');
  infoParagraphs[0].textContent = `${person.age} Years old`;
  infoParagraphs[1].textContent = `${person.location}`;
  infoParagraphs[2].textContent = `${person.looking} Years old`;
});
